...
const (
	...
	MessagingService_MarkAsRead_FullMethodName     = "/messaging.MessagingService/MarkAsRead"
)
...
func (c *messagingServiceClient) StreamMessages(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MessageEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMessagingServiceServer) StreamMessages(*StreamRequest, grpc.ServerStreamingServer[MessageEvent]) error {
...
func _MessagingService_StreamMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MessagingServiceServer).StreamMessages(m, &grpc.GenericServerStream[StreamRequest, MessageEvent]{ServerStream: stream})
}
